...
public final class RealmObservable {
    ...
    public static <T extends RealmObject> Observable<T> object(Realm context, final Func1<Realm, T> function) {
    ...
    public static <T extends RealmObject> Observable<RealmList<T>> list(Realm context, final Func1<Realm, RealmList<T>> function) {
    ...
    public static <T extends RealmObject> Observable<RealmResults<T>> results(Realm context, final Func1<Realm, RealmResults<T>> function) {
